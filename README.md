...
4. **查看报告**：扫描完成后，系统会自动生成漏洞列表，您可以在 **报告管理** 菜单中预览或下载完整的 Markdown 安全审计报告。
5. **智能分析**：在 **智能对话** 菜单中，您可以直接上传压缩包或输入 GitHub URL 让 AI 进行漏洞挖掘，并在对话中追问漏洞修复方案。

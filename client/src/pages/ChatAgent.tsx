...
export default function ChatAgent() {
  ...
  // AI 返回的 action 建议：先尝试跳转，否则发送给 AI
  const handleActionClick = (action: string) => {
    ...
    if (lowerAction.includes("规则") || lowerAction.includes("rule")) {
      ...
      setActiveTab("engine");
    } else if (lowerAction.includes("漏洞") || lowerAction.includes("vuln")) {
      // 发送给 AI 继续对话
            ...
            <div className="flex-1 flex flex-col min-h-0">
              ...
              <div className="p-4 border-t border-[#e7e5e4] bg-[#fafaf9] shrink-0">
                ...
                <p className="text-[10px] text-stone-400 mt-2 text-center">
                  由 Strix AI 漏洞挖掘引擎驱动 · 支持代码分析、漏洞解释、修复建议
                </p>
              </div>
            </div>
          ) : (
